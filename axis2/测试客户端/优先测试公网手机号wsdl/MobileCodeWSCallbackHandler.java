 ...
 * com.naruto.test.MobileCodeWSCallbackHandler.java
 *
...
/**
 *  com.naruto.test.MobileCodeWSCallbackHandler Callback class, Users can extend this class and implement
...
public abstract class MobileCodeWSCallbackHandler {
    ...
    public void receiveResultgetMobileCodeInfo(
        com.naruto.test.MobileCodeWSStub.GetMobileCodeInfoResponse result) {
    }
    ...
    public void receiveResultgetDatabaseInfo(
        com.naruto.test.MobileCodeWSStub.GetDatabaseInfoResponse result) {
    }
